...
**
** Created: Sun Aug 22 20:48:55 2010
...
const QMetaObject HistogramWidget::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HistogramWidget,
      qt_meta_data_HistogramWidget, 0 }
};
...
void *HistogramWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Dialog"))
        return static_cast< Ui::Dialog*>(const_cast< HistogramWidget*>(this));
