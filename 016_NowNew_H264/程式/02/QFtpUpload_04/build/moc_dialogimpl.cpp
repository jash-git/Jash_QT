...
**
** Created: Fri Mar 12 13:47:19 2010
...
static const char qt_meta_stringdata_DialogImpl[] = {
    "DialogImpl\0\0slotLogin()\0slotPut()\0"
    "state\0slotStateChange(int)\0error\0"
    "slotDone(bool)\0blncheck\0slotwebloaded(bool)\0"
};
...
int DialogImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: slotStateChange((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: slotDone((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: slotwebloaded((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 5;
    }
