...
**
** Created: Fri Aug 31 11:14:38 2012
...
static const char qt_meta_stringdata_MimeHtml[] = {
    "MimeHtml\0"
};

const QMetaObject MimeHtml::staticMetaObject = {
    { &MimeText::staticMetaObject, qt_meta_stringdata_MimeHtml,
      qt_meta_data_MimeHtml, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MimeHtml::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MimeHtml))
