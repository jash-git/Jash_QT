...
**
** Created: Fri Aug 31 11:14:37 2012
...
static const char qt_meta_stringdata_MimePart[] = {
    "MimePart\0"
};

const QMetaObject MimePart::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MimePart,
      qt_meta_data_MimePart, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MimePart::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MimePart))
