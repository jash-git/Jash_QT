...
**
** Created: Fri Aug 10 15:18:44 2012
...
static const char qt_meta_stringdata_DialogImpl[] = {
    "DialogImpl\0\0slotInsertData()\0"
    "slotModifyData()\0,\0slotSelectData(int,int)\0"
    "slotExportDB()\0slotTimer()\0"
};
...
int DialogImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slotInsertData(); break;
        case 1: slotModifyData(); break;
        case 2: slotSelectData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: slotExportDB(); break;
        case 4: slotTimer(); break;
        default: ;
        }
        _id -= 5;
    }
