...
**
** Created: Fri Aug 10 15:18:39 2012
...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        ModifyButton = new QPushButton(Dialog);
        ModifyButton->setObjectName(QString::fromUtf8("ModifyButton"));
        ModifyButton->setGeometry(QRect(120, 80, 98, 27));
        ExportButton = new QPushButton(Dialog);
        ExportButton->setObjectName(QString::fromUtf8("ExportButton"));
        ExportButton->setGeometry(QRect(240, 80, 98, 27));
        ...
        QObject::connect(ModifyButton, SIGNAL(clicked()), Dialog, SLOT(slotModifyData()));
        QObject::connect(ExportButton, SIGNAL(clicked()), Dialog, SLOT(slotExportDB()));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        ModifyButton->setText(QApplication::translate("Dialog", "Modify Data", 0, QApplication::UnicodeUTF8));
        ExportButton->setText(QApplication::translate("Dialog", "Export DB", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
