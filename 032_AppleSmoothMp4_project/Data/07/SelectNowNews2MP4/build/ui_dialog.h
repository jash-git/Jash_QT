...
**
** Created: Mon May 17 17:42:26 2010
...
public:
    ...
    void setupUi(QDialog *Dialog)
    {
        ...
        pushButSelectAdd = new QPushButton(Dialog);
        pushButSelectAdd->setObjectName(QString::fromUtf8("pushButSelectAdd"));
        pushButSelectAdd->setGeometry(QRect(230, 50, 151, 28));
        ...
        QObject::connect(pushButSelectAdd, SIGNAL(clicked()), Dialog, SLOT(slotSelectAdd()));
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        pushButSelectAdd->setText(QApplication::translate("Dialog", "Select/Add Files", 0, QApplication::UnicodeUTF8));
        Q_UNUSED(Dialog);
    } // retranslateUi
