...
options="-vcodec libx264 -b 4500k -flags +loop+mv4 -cmp 256 \
   ...
   -qmax 51 -qdiff 4 -s 1280x960"

ffmpeg -y -i "$1" -an -pass 1 -threads 2 $options "$2"
ffmpeg -y -i "$1" -acodec libfaac -ac 2 -ar 44100 -ab 64k -pass 2 -threads 2 $options "$2"