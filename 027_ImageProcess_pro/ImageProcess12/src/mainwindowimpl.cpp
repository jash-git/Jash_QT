...
void MainWindowImpl::slotImR()
{
	imageWidget->toImR();
}
void MainWindowImpl::slotImG()
{
	imageWidget->toImG();
}
void MainWindowImpl::slotImB()
{
	imageWidget->toImB();	
}
void MainWindowImpl::slotGradient()
{
	imageWidget->toGradient();
}
void MainWindowImpl::slotLaplacian()
{
	imageWidget->toLaplacian();
}
void MainWindowImpl::slotSaveFile()
{
