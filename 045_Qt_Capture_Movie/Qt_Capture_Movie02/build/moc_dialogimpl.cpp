...
**
** Created: Fri Feb 10 17:47:42 2012
...
static const char qt_meta_stringdata_DialogImpl[] = {
    "DialogImpl\0\0slotCapture01()\0slotTimer()\0"
    "slotVideo()\0"
};
...
void *DialogImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::MainForm"))
        return static_cast< Ui::MainForm*>(const_cast< DialogImpl*>(this));
...
int DialogImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slotCapture01(); break;
        case 1: slotTimer(); break;
        case 2: slotVideo(); break;
        default: ;
        }
        _id -= 3;
    }
