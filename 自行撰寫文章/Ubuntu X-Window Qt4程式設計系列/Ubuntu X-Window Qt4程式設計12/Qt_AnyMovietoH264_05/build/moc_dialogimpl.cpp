...
**
** Created: Sat Apr 14 16:04:04 2012
...
static const char qt_meta_stringdata_DialogImpl[] = {
    "DialogImpl\0\0slotSelect()\0slotDetail()\0"
    "slotRun()\0outputCommand()\0exitCode,exitStatus\0"
...
void *DialogImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::AnyMovietoH264"))
        return static_cast< Ui::AnyMovietoH264*>(const_cast< DialogImpl*>(this));
...
int DialogImpl::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slotSelect(); break;
        case 1: slotDetail(); break;
        case 2: slotRun(); break;
        case 3: outputCommand(); break;
        case 4: processFinished((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QProcess::ExitStatus(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 5;
    }
