...
void MainWindowImpl::slotOverlayImage()//5-5 by jash
{
	QString StrFilePath;
	StrFilePath=QFileDialog::getOpenFileName(this,"Select File","/home/","(*.*)");
	imageWidget->toOverlayImage(StrFilePath);	
}
void MainWindowImpl::slotOverlayText()//5-5 by jash
{
	QString StrText;
	StrText="Overlay 中文字";
	imageWidget->toOverlayText(StrText);	
}
//
