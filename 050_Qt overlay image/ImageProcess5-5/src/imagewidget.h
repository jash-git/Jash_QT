...
public:
	...
	void toRotate(double dblRotate);//5-3 by jash
	void toSobel();//5-4 by jash
	void toRoberts();//5-4 by jash
	void toLaplacian();//5-4 by jash
	void toPrewitt();//5-4 by jash
	void toThinning();//5-4 by jash	
	int cconc(int inb[9]);//5-4 by jash
	void toOverlayImage(QString StrFileName);//5-5 by jash
	void toOverlayText(QString StrText);//5-5 by jash
